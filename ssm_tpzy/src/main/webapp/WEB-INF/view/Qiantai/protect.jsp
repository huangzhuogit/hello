  ...
  <section class="sec" style="  background: url(../images/子页面1.png) repeat;background-size:100%;">
    ...
    <div class="container" style="line-height:40px;font-size:12px;color:#fff;">
      <p>
        ...
        <a href="#" style="color:#fff;"><span>刑事勘查</span></a>>
        <a href="#" style="color:#fff;"><span>${te.name}</span></a>
      </p>

      <h4 style="line-height:50px;color:rgb(184, 184,184) ">${te.name}</h4>
    </div>
    <div style="width:100%;">
      ...
      <div class="tcontainer" style="line-height:40px;font-size:12px;color:#fff;position:relative;left:-105px;">
        <div style="width:210px;padding: 5px;font-size:14px; z-index:999;float:left;display:block">
          ...
          <ul id="leftNavigation" style="margin-top:-5px;">
            ...
            <li class="active">
              <a href="#" style="color:rgb(184, 184,184) ;font-size:16px;border:none;"><i class="fa fa-coffee leftNavIcon" style="color:#fff;position:relative;font-size:16px;"></i>刑事勘查</a>
              <ul>
                <li>
        ...
        <div class="container" style="position:relative;left:105px;background:rgb(67, 67, 94);">
                  ...
                  <div>
                    <div class="tab-content">
                      <div class="tab-pane  active" id="video-1">
                        <div class="video-playground bg-img" style="background-image: url(../hp_layui/img/${te.img});">
                          <!-- Play Button -->
                          <div class="play-btn">
                            <video src="../hp_layui/movie/${te.tvideo}" controls="controls" style="width:765px;"></video>
                          </div>
                        </div>
                      </div>
                    ...
                    <a class="nav-link active" id="video1" data-toggle="pill" href="#video-1" role="tab" aria-controls="video-1"
                      ...
                      <div class="single-video-widget d-flex wow fadeInUp" data-wow-delay="100ms">
                        <div class="video-thumbnail">
                          <img style="height: 90px; width: 300px" src="../hp_layui/img/${te.img}" alt="" style="size: 100%">
                        </div>
          ...
          word-break:break-all;white-space:normal;overflow:hidden;" >
            <img src="../hp_layui/img/${te.img }" alt="" style="width:400px; height: 200px;" />
          <div style="color:rgb(184, 184, 184);">
            <p style="color:rgb(180, 209, 253);margin-top:5px;">产品简介：</p>
         <p style="text-indent:2em;">${te.product}</p>
        </div>
        <div style="margin-top:5px;">
          <p style="color:rgb(180, 209, 253);">适用领域：</p>
          <p style="color:rgb(184, 184, 184);text-indent:2em;">${te.territory }</p>
         </div>
           </div>
    ...
    <div style="width:100%;">
      <div class="container" style="font-size:14px;color:#cfcfcf;padding: 10px;">
        ...
        <div style="width:90%;margin-left:-1px">
          <p style="line-height:25px;margin:-15px 10px 10px 10px;text-indent:2em;color:rgb(184, 184, 184)">${te.mark}</p>
        ...
        <div>
          ...
          <div class="owl-carousel popular-places">
            ...
            <c:forEach items="${tlistone}" var="tone" begin="0" end="0">
              <a href="<%=basePath%>shouye/toprotet?id=${tone.id}">
                <div class="thumb"  >
                ...
                <a href="<%=basePath%>shouye/toprotet?id=${tone.id}">
                  ...
                  <div class="thumb"  >
                      ...
                      <div class="plus-button">
                        ...
                        <div class=" popular-item">
                         <c:forEach items="${tlisttwo}" var="tone" begin="1" end="1">
                 <a href="<%=basePath%>shouye/toprotet?id=${tone.id}">
                  <div class="thumb"  >
                      <img src="../hp_layui/img/${tone.img}" alt="" style="border:2px solid rgb(76, 78, 109);height: 240px;">
                      <div class="text-content" style="height:30px;">
           ...
           <div class=" popular-item">
                   <c:forEach items="${tlisttwo}" var="tone" begin="2" end="2">
                  <a href="<%=basePath%>shouye/toprotet?id=${tone.id}">
                  <div class="thumb"  >
                      <img src="../hp_layui/img/${tone.img}" alt="" style="border:2px solid rgb(76, 78, 109);height: 240px;">
                      <div class="text-content" style="height:30px;">
               ...
               <div class=" popular-item">
                  <c:forEach items="${tlisttwo}" var="tone" begin="3" end="3">
                <a href="<%=basePath%>shouye/toprotet?id=${tone.id}">
                  <div class="thumb"  >
                      <img src="../hp_layui/img/${tone.img}" alt="" style="border:2px solid rgb(76, 78, 109);height: 240px;">
                      <div class="text-content" style="height:30px;">
                ...
                <div class=" popular-item">
                  <c:forEach items="${tlisttwo}" var="tone" begin="4" end="4">
                <a href="<%=basePath%>shouye/toprotet?id=${tone.id}">
                  <div class="thumb"  >
                      <img src="../hp_layui/img/${tone.img}" alt="" style="border:2px solid rgb(76, 78, 109);height: 240px;">
                      <div class="text-content" style="height:30px;">
                ...
                <div class=" popular-item">
                  <c:forEach items="${tlisttwo}" var="tone" begin="5" end="5">
                <a href="<%=basePath%>shouye/toprotet?id=${tone.id}">
                  <div class="thumb"  >
                      <img src="../hp_layui/img/${tone.img}" alt="" style="border:2px solid rgb(76, 78, 109);height: 240px;">
                      <div class="text-content" style="height:30px;">
