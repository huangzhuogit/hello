...
<body>
  ...
  <section class="sec" style="  background:rgb(36, 35, 43);">
        ...
        <div class="nav_content">
          ...
          <div class="top-menu" style="color:#fff;">
              <ul>
                 ...
                 <li><a style="color:#fff;" href="<%=basePath%>shouye/contectus">关于我们</a></li>
             </ul>
          </div>
        </div>
      </div>
    ...
    <div class="container" style="color:#fff;">
      <p>
        <a href="<%=basePath%>shouye/news" style="color:#fff;line-height:40px;font-size:12px;color:#fff;"><span>行业资讯 ></span></a>
        <a href="#" style="color:#fff;line-height:40px;font-size:12px;color:#fff;"><span>${gyzx.hyzxTypeName }</span></a>
      </p>
      ...
      <div>
          <div style="background:#fff;">
            ...
            <h3 style="color:rgb(180, 209, 253);">${gyzx.hyzxTypeName }</h3>
        </div>
            <div style="height:30px;width:9.5%;float:left;margin-top:10px;">
                <span style="font-size:14px;">2017年12月24日</span>
            </div>
        </div>
        <img src="../hp_layui/img/${gyzx.hyzxTestImg }" alt="" style="width:100%;height:400px;margin-top:20px;margin-bottom:20px;">
        <div>
