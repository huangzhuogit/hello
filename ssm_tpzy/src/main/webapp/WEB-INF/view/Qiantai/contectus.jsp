...
<body>
  ...
  <section class="sec" style="  background:rgb(36, 35, 43);">
    <div style="width:100%;">
      ...
      <div class="container" style=" background: url(../images/项目栏1.png) repeat;background-size:100%;border-radius: 5px;padding-right:0">
    ...
    <div class="container" style="color:#fff;">
      <p>
        <a href="#" style="color:#fff;line-height:40px;font-size:12px;color:#fff;"><span>关于网站</span></a>
      </p>

      <h1 style="line-height:50px;color:#fff;margin-top:0;">关于网站</h1>
      ...
      <div>
          <div style="background:#fff;">
            ...
            <a href="<%=basePath%>shouye/usdetail?gywmTestId=${list.gywmTestId}">
            <h3 style="color:rgb(180, 209, 253);">${list.gywmTypeName }</h3>
            </a>
             </c:forEach>
        </div>
        ...
        <c:forEach items="${list}" var="list" begin="0" end="0">
            <p style="font-size:14px;text-indent:2em;line-height:25px;">
               ${list.gywmTestName }
        </p>
        </c:forEach>
        </div>
         <c:forEach items="${list}" var="list" begin="0" end="0">
        <img src="../hp_layui/img/${list.gywmTestImg }" alt="" style="width:100%;height:300px;margin-top:20px;margin-bottom:20px;">
        </c:forEach>
      </div>
      <div>
        <div>
        <c:forEach items="${list}" var="list" begin="1" end="1">
            <p style="font-size:14px;text-indent:1em;line-height:25px;">
            ${list.gywmTestName }
        </p>
        </c:forEach>
        </div>
        ...
        <div class="container" style="padding-top:20px;">
          ...
          <div class="bk" id="right-content" style="height:30px;font-size:16px;color:#fff;padding-top:10px;">
            <center>  
              ...
              <a style="font-weight:100;color:rgb(180, 209, 253);" href="<%=basePath%>shouye/indexJsp">刑事勘查</a>&nbsp;
              <span style="color:#fff;">|</span>&nbsp;
              <a style="font-weight:100;color:rgb(180, 209, 253);" href="<%=basePath%>shouye/indexJsp">交通管理</a>&nbsp;|&nbsp;
              <a style="font-weight:100;color:rgb(180, 209, 253);" href="<%=basePath%>shouye/indexJsp">治安管理</a>&nbsp;|&nbsp;
              <a style="font-weight:100;color:rgb(180, 209, 253);" href="<%=basePath%>shouye/indexJsp">警务战术</a>&nbsp;|&nbsp;
              <a style="font-weight:100;color:rgb(180, 209, 253);" href="<%=basePath%>shouye/indexJsp">反恐训练</a>&nbsp;|&nbsp;
              <a style="font-weight:100;color:rgb(180, 209, 253);" href="<%=basePath%>shouye/indexJsp">行业资讯</a>&nbsp;|&nbsp;
              <a style="font-weight:100;color:rgb(180, 209, 253);" href="<%=basePath%>shouye/indexJsp">关于网站</a>
          </center>
          </div>
        </div>
        <div class="container">
