...
<body>
  ...
  <section class="sec" style="  background:rgb(36, 35, 43);">
    ...
    <div class="container" style="color:#fff;">
      <p>
        <a href="<%=basePath%>shouye/contectus" style="color:#fff;line-height:40px;font-size:12px;color:#fff;"><span>关于网站 ></span></a>
        <a href="#" style="color:#fff;line-height:40px;font-size:12px;color:#fff;"><span>${gy.gywmTypeName}</span></a>
      </p>
      ...
      <div>
          <div style="background:#fff;">
            ...
            <h3 style="color:rgb(180, 209, 253);">${gy.gywmTypeName}</h3>
        </div>
            <div style="height:30px;width:9.5%;float:left;margin-top:10px;">
            </div>
        </div>
        <div>
        <img src="../hp_layui/img/${gy.gywmTestImg }" alt="" style="width:100%;height:400px;margin-top:20px;margin-bottom:20px;">
